      ...
      <section className="bg-white py-24 px-8">
        <div className="max-w-[900px] mx-auto">
          ...
          <TestimonialsGrid testimonials={[
            ...
            { photo: "https://chrisbradshaw.ai/wp-content/uploads/2023/07/Linda_Ayoola-300x300.jpg", name: "Linda Ayoola", role: "TEDx UK", q: "I highly recommend Chris for his outstanding work building and executing our AI strategy at TEDx London. Chris brought genuine strategic and technical knowledge to what felt like an overwhelming topic. His guidance was instrumental in helping us understand where AI could actually move the needle — and quickly." },
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row max-w-[900px] mx-auto">
            <div className="flex-1 p-10 bg-white border-2 border-brand-primary">
              ...
              <p className="text-sm text-brand-text/80 my-4 italic">Until 19th June 2026</p>
              <ShiftingCountdown />
              <a
                href="/apply/cxo"
      ...
      <section className="bg-white py-24 px-8">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="max-w-[800px] mx-auto">
            {[
              { q: "Are there early bird discounts?", a: "Yes. Register before 19th June 2026 for the early bird rate of £899 + VAT. After that, the standard price of £1,099 + VAT applies. If spaces are still available on the day, the on-the-door price is £1,299 + VAT." },
