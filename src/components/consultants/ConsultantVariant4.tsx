...
export default function ConsultantVariant4() {
  return (
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl font-bold font-roboto leading-tight tracking-tighter mb-8 uppercase">
              The AI Advisory Day <br />
              <span className="text-brand-primary">For Partners</span>
            </h1>
            <p className="text-xl md:text-3xl text-gray-600 max-w-4xl mx-auto mb-12 leading-relaxed">
              Your clients are hiring AI consultants. Are you one of them? A private, high-energy working session in London to gain absolute AI confidence.
            </p>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 leading-relaxed mb-12">
            You advise leaders on transformation. But when they ask about AI, how confident are you really? Most partners are selling AI advice they don't fully understand while feeling the silent pressure to have all the answers. 
            <span className="block mt-6 font-bold text-black">This is the only room where you can take off the mask and master the future you're already selling.</span>
          </p>
          <div className="grid md:grid-cols-2 gap-8 text-left">
            <div className="p-8 bg-brand-surface border border-brand-border rounded-2xl">
              ...
              <p className="text-gray-600">Nervousness in client engagements, relying on jargon, and feeling behind the curve.</p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-px bg-brand-border border border-brand-border rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="bg-white p-12 md:p-16">
              ...
              <h3 className="text-3xl font-bold font-roboto mb-6 uppercase">Advisory Mastery</h3>
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                How do you lead high-stakes AI strategy sessions? We build the specific frameworks you need to diagnose client readiness and spot vendor hype.
              </p>
              <ul className="space-y-4">
                {[
                  "Diagnosing Client AI Readiness: Immediate frameworks.",
                  "Spotting Vendor Nonsense: Protecting your client's interests.",
                  "Practical Exercises: Real-time roadmapping exercises.",
                  "The Billable Win: Reclaiming your advisory authority."
                ].map((item, i) => (
