...
export default function ConsultantVariant3() {
  return (
    <div className="min-h-screen bg-brand-bg text-brand-text selection:bg-brand-primary selection:text-white font-quicksand">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-12">
            <div className="space-y-6">
              ...
              <h3 className="text-2xl font-bold text-brand-text">Client Readiness</h3>
              <p className="text-gray-600 leading-relaxed">
                Frameworks you can use to diagnose AI readiness and maturity in any client organization within hours, not weeks.
              </p>
            </div>
            <div className="space-y-6">
              <div className="w-12 h-12 bg-brand-primary/10 flex items-center justify-center rounded-lg">
              ...
              <h3 className="text-2xl font-bold text-brand-text">Neutral Mastery</h3>
              <p className="text-gray-600 leading-relaxed">
                The ability to spot vendor hype and software noise on behalf of your clients. Shift from a buyer to a judge.
              </p>
            </div>
            <div className="space-y-6">
              <div className="w-12 h-12 bg-brand-primary/10 flex items-center justify-center rounded-lg">
              ...
              <h3 className="text-2xl font-bold text-brand-text">Strategic Language</h3>
              <p className="text-gray-600 leading-relaxed">
                Move beyond literacy to the specific language of business transformation through AI. Speak the economics, not the tech.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="py-24 px-6 text-center border-t border-brand-border">
        <p className="text-gray-400 text-sm uppercase tracking-[0.5em] mb-8">Solved Together • 19th June • London</p>
        <h2 className="text-3xl font-bold mb-4 text-brand-text">Don't figure it out alone.</h2>
        <p className="text-gray-500 mb-0">Join 11 other partners on 19th June for a day that changes how you lead AI conversations.</p>
      </footer>
    </div>
  );
}
