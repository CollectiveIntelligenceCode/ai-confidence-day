...
export default function ConsultantVariant6() {
  return (
    <div className="min-h-screen bg-white text-[#1a1a1a] font-quicksand relative overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-[800] h-[62px] flex items-center justify-between px-10 bg-white/94 backdrop-blur-md border-b border-black/10">
        ...
        <div className="flex items-center gap-8">
          <span className="hidden md:block font-roboto text-[10px] font-bold uppercase tracking-widest text-gray-500">19th June 2026</span>
        ...
        <div className="max-w-6xl mx-auto w-full relative z-10">
          ...
          >
            ...
            <h1 className="font-roboto font-bold text-6xl md:text-8xl lg:text-9xl leading-[0.95] tracking-tighter text-black mb-12">
              Your clients are<br />
              hiring <span className="italic text-brand-primary">AI Consultants.</span>
            </h1>

            <div className="grid lg:grid-cols-[1fr_auto] gap-12 items-end">
              <div>
                <p className="max-w-xl text-xl text-gray-600 leading-relaxed mb-10">
                  Are you one of them? A full-day workshop for Strategy Partners to stop selling AI advice they don't fully understand and start leading with genuine authority.
                </p>
                <div className="flex flex-col items-start gap-4">
                  <CTAButton className="px-12 py-4 text-xs tracking-[0.15em]">Apply for a Seat →</CTAButton>
                  <span className="font-roboto text-[10px] uppercase tracking-widest text-gray-400">Limited cohort · 19th June 2026 · £899 + VAT</span>
                </div>
              </div>
      ...
      <section className="py-32 px-10">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="font-roboto text-4xl md:text-5xl font-light leading-tight text-black max-w-3xl mb-20">
            AI is moving fast. Your clients want a strategy. <span className="italic text-brand-primary">Are you selling one you don't fully understand?</span> The gap in your knowledge is your biggest billable risk.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 border border-black/15">
            {[
              ...
              { num: "02", title: "Client Pressure, No Clarity", desc: "Clients want a coherent AI strategy. You need to answer confidently — without becoming a technical expert first." },
          ...
          <div className="grid lg:grid-cols-2 gap-0.5">
            {[
              { 
                ...
                title: "Advisory Mastery", 
                sub: "High-Stakes Client Engagement",
                body: "A hands-on session built around real client advisory problems. You'll move beyond generic AI literacy to the specific frameworks needed to diagnose client readiness and spot vendor hype.",
                list: ["Diagnosing client AI readiness in hours", "Spotting vendor hype for your clients", "Building AI-driven transformation roadmaps", "Frameworks for AI economics and pricing", "Language to lead with authority"]
              },
              { 
                period: "PM", 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 border border-black/15">
            {[
              ...
              { num: "04", title: "Understanding Real ROI", desc: "What results look like. How to evaluate vendor claims and answer client questions with confidence." },
          ...
          <div className="grid md:grid-cols-2 border border-black/15">
            <div className="p-12">
              ...
              <ul className="space-y-4">
                {[
                  "You're a Partner, Founder, or Practice Lead responsible for strategic direction",
      ...
      <section className="py-40 px-10 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="font-roboto font-bold text-sm uppercase tracking-widest text-brand-primary mb-8">19th June 2026 · Consultant AI Day</div>
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            ...
            <span className="font-roboto text-[10px] uppercase tracking-widest text-gray-400">Consultant AI Day</span>
            <span className="w-1 h-1 bg-gray-200 rounded-full" />
