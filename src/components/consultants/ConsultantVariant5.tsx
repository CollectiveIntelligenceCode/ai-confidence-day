...
export default function ConsultantVariant5() {
  return (
          ...
          >
            <div className="flex items-center gap-6 mb-10">
              <div className="inline-flex items-center gap-2.5 px-4 py-2 border border-brand-primary text-brand-primary font-roboto font-bold text-sm uppercase tracking-widest">
                ...
                Consultant AI Day · 19th June 2026
              </div>
            ...
            <div className="grid lg:grid-cols-[1fr_auto] gap-16 items-end">
              <div>
                <h1 className="font-roboto font-bold text-6xl md:text-8xl lg:text-9xl leading-[1.05] tracking-tighter text-white mb-8">
                  Advice is your<br />
                  <span className="italic text-brand-primary">Product.</span>
                </h1>
                <p className="max-w-xl text-xl md:text-2xl text-gray-400 leading-relaxed mb-10">
                  You advise leaders on transformation. But when they ask about AI, how confident are you really? A private working day in London for partners to master the future they're already selling.
                </p>
      ...
      <section className="py-28 px-8 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="font-roboto text-3xl md:text-5xl font-light leading-tight text-white max-w-3xl mb-16">
            Clients are hiring AI consultants. <span className="italic text-brand-primary">Are you one of them?</span> The gap between your proposals and your knowledge is your biggest billable risk.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 border border-white/5">
            {[
              ...
              { num: "02", title: "Client pressure, no clarity", desc: "Your clients want a coherent AI strategy. You need to answer confidently — without becoming a technical expert first." },
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 border border-white/5">
            ...
            <div className="p-12 relative overflow-hidden border-b lg:border-b-0 lg:border-r border-white/5">
              ...
              <h3 className="font-roboto font-bold text-4xl text-white mb-2">Advisory Mastery</h3>
              <p className="font-roboto text-sm uppercase tracking-widest text-brand-primary mb-6">High-Stakes Client Engagement</p>
              <p className="text-lg text-gray-400 leading-relaxed mb-8 relative z-10">
                A hands-on session structured around real client advisory problems. You'll move beyond generic AI literacy to the specific frameworks needed to lead transformations and deliver boardroom-level results.
              </p>
              <ul className="space-y-3 relative z-10">
                {[
                  "Diagnosing client AI readiness in hours",
                  "Spotting vendor hype for your clients",
                  "Building AI-driven transformation roadmaps",
                  "Frameworks for AI economics and pricing",
                  "Language to lead with genuine authority"
                ].map((item, i) => (
            ...
            <div className="p-12 relative overflow-hidden">
              ...
              <ul className="space-y-3 relative z-10">
                {[
                  ...
                  "How to evaluate vendor claims and answer client questions",
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            <div className="border border-white/5">
              {[
                ...
                { key: "Cohort", val: "Limited to 12 consultants" },
